CREATE TABLE users (username character varying(255) NOT NULL, email character varying(255), password character varying(255) NOT NULL, prefix character varying(255) NOT NULL, CONSTRAINT users_pkey PRIMARY KEY (username));
