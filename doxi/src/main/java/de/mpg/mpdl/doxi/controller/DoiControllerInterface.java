...
public interface DoiControllerInterface {
   ...
   * @throws DoiRegisterException
   */
  public DOI createDOIAutoGenerated(String url, String metadataXml) throws DoxiException,
      DoiAlreadyExistsException, MetadataInvalidException, DoiRegisterException;

  /**
   * registers a given DOI suffix with the according prefix and the given metadata and URL
   * 
   * @param suffix
   * @param url
   * @param metadataXml
